...
BLOG_AUTHOR = "Matt Anderson"  # (translatable)
BLOG_TITLE = "Food"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://maxb2.github.io/food/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://maxb2.github.io/food/"
BLOG_EMAIL = "matt@manderscience.com"
BLOG_DESCRIPTION = "A food blog."  # (translatable)
